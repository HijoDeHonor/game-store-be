import { ALREADY_EXIST_ERROR, INTERNAL_SERVER_ERROR, INVALID_DATA_ERROR, INVALID_LOGIN_ERROR, USER_DONT_EXIST_ERROR } from "../../utils/textConstants.js";

const errors = {
  [ALREADY_EXIST_ERROR]: 400,
  [INVALID_DATA_ERROR]: 400,
  [INVALID_LOGIN_ERROR]: 400,
  [USER_DONT_EXIST_ERROR]: 400,
};
